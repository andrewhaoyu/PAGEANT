...
Fast option runs genome-wide calculations within 3 minutes and provides rough estimates. Intermediate option runs genome-wide calculations within 6 minutes and provides more accurate estimates over 50 possible effect size distributions. Lastly, most accurate option runs genome-wide calculations within 15 minutes and provides very accurate estimates over 100 possible effect size distributions.
                 ...
                 p("Probability of discoveries: This returns maximum and minimum probability of a certain number of discoveries (m) for values of specified by the user. ", style = "font-family: 'times'; font-si20pt"),
                 h3("Additional notes"),
             ...
             sidebarPanel(
               ...
               conditionalPanel(
                 ...
                 conditionalPanel(
                   ...
                   conditionalPanel(
                     condition="input.SNPoption_s=='Single Gene'",
    ...
    tabPanel("Quantitative Trait",
             ...
             sidebarPanel( 
               selectInput("TypeofCalculation2", 
                           "Type of calculation",
                           c("Power Calculation","Sample Size Calculation")),
               conditionalPanel(
                 condition = "input.TypeofCalculation2=='Power Calculation'",
               ...
               conditionalPanel(
                 condition = "input.TypeofCalculation2=='Sample Size Calculation'",
