...
get_Aprox <- function(EV,alpha,Total,CASE=NULL,CONTROL=NULL,PC=NULL,TEST = 'SKAT',QT='CC',nameEsseble=NULL,JJ=NULL,PRC=NULL){
  if(length(EV)==1&TEST!='Burden Test'){
    ...
    Gene_Arc_1 <- c(mmBinP,qunatBinP)
    Gene_Arc_2 <- c(mmEinP,qunatEinP)
    ...
    MeanPower.combine <- data.frame(EV=EV*100,GeneI =BinMean,GeneII = EinMean,GeneIII=BrelMean)
...
get_Aprox1  = function(EV,alpha,Total,CASE=NULL,CONTROL=NULL,PC=NULL,TEST = 'SKAT',QT='CC',nameEsseble=NULL,JJ=NULL){
PowerEindP = NULL
PowerBindP = NULL
PowerRelBandP = NULL
n = CASE*CONTROL/Total
...
get_Aprox2  = function(EV,alpha,Total,CASE=NULL,CONTROL=NULL,PC=NULL,TEST = 'SKAT',QT='CC',nameEsseble=NULL,JJ=NULL){
  PowerEindP = NULL
  PowerBindP = NULL
  PowerRelBandP = NULL
  n = CASE*CONTROL/Total
...
#   Burden (w=1)
#		for burden test default values are: PC is set to 5% and 0% PRC: 
#  		PRC: proportion of protective variants 
#



get_AproxL  = function(EV,alpha,Total,CASE=NULL,CONTROL=NULL,PC=0.05,PRC=0,QT='CC',nameEsseble=NULL,JJ=NULL){
Power= NULL
