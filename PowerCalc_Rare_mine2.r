...
theme_new <- function(base_size = 12, base_family = "Helvetica"){
  theme_bw(base_size = base_size, base_family = base_family) %+replace%
    theme(plot.title=element_text(size=12,face="bold.italic",hjust = 0.5,vjust=1),
...
# Delete nameEsseble
#
get_Aprox2 = function(E,alpha,Total,CASE=NULL,CONTROL=NULL,PC=NULL,QT='CC',nameEsseble=NULL,JJ=NULL){
PowerEindP = NULL
PowerBindP = NULL
PowerRelBandP = NULL
