get_AproxQ2  = function(al,be,K,alpha,Total,Obj,perm,CASE=NULL,CONTROL=NULL,PC=NULL,TEST = 'SKAT',QT='CC',nameEsseble=NULL,JJ=NULL,PRC=NULL){
  PowerEindP = NULL
  PowerBindP = NULL
  PowerRelBandP = NULL
  EE = NULL
